<template>
    <div class="test">
        ...
        <div class="xiati">
           <div class="xiati1">
            <van-button icon="arrow-left" type="primary" to='/bei4'/>
           </div>
           <div class="xiati2">       
            <van-button icon="arrow" type="primary" to='/bei2'/>
        </div>
        </div>
        <div class="test_but" >
                ...
                <div class="tt">
                    ...
                    <div class="tt1" @click="gobeidetail(list)">
                        <div class="ttr">
